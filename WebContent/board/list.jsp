...
<table>
	<tr>
		...
		<td align="right">
			<form name="npFrm" method="post"> <!-- post방식의 npFrm의 이름을 가지고 있는 form -->
					<select name="numPerPage" size="1" onchange="numPerFn(this.form.numPerPage.value)">
					<!-- select name에 따라서 onchange 될것이다. 
					this.form.numPerPage.value값을 numPerFn로 들고가라 -->
...
<table>
	...
	<tr>
		...
		<td align="right">
			...
			<!-- function.list는 list.jsp로 이동하는 것, 새로고침 -->
		</td>
	</tr>
</table>
